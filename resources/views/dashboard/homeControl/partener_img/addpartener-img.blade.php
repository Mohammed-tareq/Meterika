...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>New partener Img</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('parteners.index') }}" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('parteners.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h2 class="h4 mb-3">Media Image For Partener</h2>
                                        ...
                                        <div class="preview-container" id="preview-container">
                                            <img id="previewImage" style="display: none; max-width: 100%; height: 250px; margin-top: 10px;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a type="reset" href="{{ route('parteners.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </form>
        </div>
        <!-- /.card -->
