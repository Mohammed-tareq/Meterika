                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="upload-container" onclick="document.getElementById('video-input').click()">
                                        ...
                                        <input type="file" id="video-input" name="slider_video"
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="upload-container"
                                        onclick="document.getElementById('file-input-one').click()">
                                        <p>Drop files here or click to upload.</p>
                                        <input type="file" id="file-input-one" name="slider_img_one" accept="image/*"
                                            style="display: none;">
                                    </div>
                                    <div class="preview-container" id="preview-container-one"></div>
                                </div>
                            </div>

                            <div class="card mb-3">
                                <div class="card-body">
                                    <h2 class="h4 mb-3">Media Image Slide Two</h2>
                                    <div class="upload-container"
                                        onclick="document.getElementById('file-input-two').click()">
                                        <p>Drop files here or click to upload.</p>
                                        <input type="file" id="file-input-two" name="slider_img_two" accept="image/*"
                                            style="display: none;">
                                    </div>
                                    <div class="preview-container" id="preview-container-two"></div>
                                </div>
                            </div>
...
@push('js')
    <script>
        ...
        handleFileUpload('file-input-one', 'preview-container-one');
        handleFileUpload('file-input-two', 'preview-container-two');
    </script>
    <script>
