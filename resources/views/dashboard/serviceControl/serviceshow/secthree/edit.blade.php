...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('ShowService-SecThree.update', $SecThree->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="title_1" id="nameInput" class="form-control"
                                        placeholder="Service Name"  maxlength="30" value="{{ $SecThree->title_1 }}">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_1" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecThree->txt_1 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_2" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecThree->txt_2 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_3" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecThree->txt_3 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_4" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecThree->txt_4 }}">
                                        <small>*Your max size is 30 characters*</small>
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="file" id="imageInput" accept="image/*" name="img_1"
                                                onchange="showImage(event)">
                                            <img id="previewImage" src="{{ $SecThree->img_1 }}"
                            ...
                            <div class="col-md-10">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="title_2" id="nameInput" class="form-control"
                                        placeholder="Project Name" maxlength="30" value="{{ $SecThree->title_2 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt2_1" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecThree->txt2_1 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt2_2" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecThree->txt2_2 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt2_3" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecThree->txt2_3 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt2_4" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecThree->txt2_4 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt2_5" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecThree->txt2_5 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt2_6" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecThree->txt2_6 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-12">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h2 class="h4 mb-3">Media Image For Project </h2>
                                        <div class="d-flex align-items-center">
                                            <input type="file" id="imageInput" accept="image/*" name="img_2"
                                                onchange="showImage(event)">
                                            <img id="previewImage" src="{{ $SecThree->img_2 }}"
                                                style="max-width: 70px; height: auto; margin:20px;" />
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a type="reset" href="{{ route('ShowService-SecThree.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </form>
        </div>
        <!-- /.card -->
...
<script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const textarea2 = document.getElementById("commitmentText2");
