...
@section('content')
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('ShowService-SecFour.index') }}" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('ShowService-SecFour.update', $SecFour->id) }}" method="post"
                            ...
                            <div class="col-md-10">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="title_1" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->title_1 }}">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_1" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->txt_1 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_2" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->txt_2 }}" >
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_3" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->txt_3 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_4" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->txt_4 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_5" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->txt_5 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_6" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->txt_6 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_7" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->txt_7 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_8" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->txt_8 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_9" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->txt_9 }}">
                                        <small>*Your max size is 30 characters*</small>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="txt_10" id="nameInput" class="form-control"
                                        placeholder="Service Name" maxlength="30" value="{{ $SecFour->txt_10 }}">
                                        <small>*Your max size is 30 characters*</small>
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <img id="previewImage" src="{{ $SecFour->img_1 }}"
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a type="reset" href="{{ route('ShowService-SecFour.index') }}"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            textarea.addEventListener("input", function() {
                ...
                if (textLength > 100) {
                    textarea.value = textarea.value.substring(0, 100); // Trim excess characters
                }
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document.querySelectorAll('.commitmentText').forEach(textarea => {
                ...
                .nextElementSibling; // Get the corresponding <p> for character count
